...
void LCD_ShowPicture(uint16_t x,uint16_t y,uint16_t width,uint16_t height,uint8_t *p);//显示图片需要取模
...
void LCD_ShowStringAndHz(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p,u8 mode);//显示中文需要取模
