...
int main(void)
{
	...
	// LCD_ShowStringAndHz(10,20,150,16,16,(u8*)"你好,世界",0); // 起点坐标(10,20)  区域大小(150,16) 字体大小16  
	
	LCD_ShowPicture(0,0,240,320,(u8*)gImage_lhj); // 背景图片
	LCD_ShowPicture(0,20,16,16,(u8*)gImage_hum); // 湿度图标
	LCD_ShowPicture(0,40,16,16,(u8*)gImage_temp); // 温度图标
	LCD_ShowPicture(0,60,16,16,(u8*)gImage_smoke); // 烟雾图标
	LCD_ShowPicture(0,80,16,16,(u8*)gImage_light); // 光照图标
