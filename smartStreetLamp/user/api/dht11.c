...
u8 GET_DHT11DATA(void)
{
	...
	for(i=0;i<40;i++)
	{
		...
		if(check == data[4])
		{
			...
			LCD_ShowStringAndHz(15,40,150,16,16,(u8*)dht11_buff,0); // 起点坐标(15,40)  区域大小(150,16) 字体大小16  
			
			sprintf((char*)dht11_buff,"湿度:%d",data[0]); // 拼接湿度
			LCD_ShowStringAndHz(15,60,150,16,16,(u8*)dht11_buff,0); // 起点坐标(15,20)  区域大小(150,16) 字体大小16  
